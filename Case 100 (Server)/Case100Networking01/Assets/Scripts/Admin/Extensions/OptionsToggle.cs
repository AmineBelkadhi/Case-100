...
namespace UnityEngine.UI
{
    ...
    /// </remarks>
    [AddComponentMenu("UI/SceneToggle")]
    [RequireComponent(typeof(RectTransform))]
    public class OptionsToggle : Selectable, IPointerClickHandler, ISubmitHandler, ICanvasElement
    {
        /// <summary>
        ...
        [SerializeField]
        private ToggleGroupExtension m_Group;

        /// <summary>
        /// Group the toggle belongs to.
        /// </summary>
        public ToggleGroupExtension group
        {
            get { return m_Group; }
            set
            {
        ...
        private void SetToggleGroup(ToggleGroupExtension newGroup, bool setMemberValue)
        {
            ToggleGroupExtension oldGroup = m_Group;
